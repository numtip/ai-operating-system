...
| **v1.6** | In progress (Stage 0 done) | Integration-First Hermes Runtime: Blueprint V4 baseline accepted; adapter contract + capability matrix + rollback plan + GOFFICE2026 pilot design; Stage 0 read-only PASS_WITH_NOTES (2026-08-09); Gate-A prerequisites READY; Hermes NOT installed (ADR-0013) |
