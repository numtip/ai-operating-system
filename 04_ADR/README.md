...
Index of accepted decisions for AI Operating System v1.

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-TEMPLATE](ADR-TEMPLATE.md) | Template for new ADRs | — |
| [ADR-0001](ADR-0001-local-first-development.md) | Local-First Development | Accepted |
| [ADR-0002](ADR-0002-github-source-of-truth.md) | GitHub as Source of Truth | Accepted |
| [ADR-0003](ADR-0003-obsidian-knowledge-interface.md) | Obsidian as Knowledge Interface | Accepted |
| [ADR-0004](ADR-0004-hermes-deferred-phase-2.md) | Hermes Deferred to Phase 2 | Accepted |
| [ADR-0005](ADR-0005-context-engine-core-layer.md) | Context Engine as Core Layer | Accepted |
| [ADR-0006](ADR-0006-file-based-indexes-before-vector.md) | File-Based Indexes Before Vector Search | Accepted |
